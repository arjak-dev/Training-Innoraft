...
<html>
  <head>
    ...
    <link rel = "icon" type = "image/png" 
      href = "title_logos/icons8-toggle-off-64.png">
    <link rel="stylesheet" 
  ...
  <body>
    <div class="reg_bg_div">
      <div class = "card bg-dark text-white reg_div">
        <form action="registration" method="POST" id="form_call" 
          ...
          <a class="btn btn-secondary button-position" href="home">
            CANCEL
          </a>
        </form>
      </div>
