      ...
      <li class='nav-item profile-li'>
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-div" aria-labelledby="dropdownMenu2">
            ...
            <a class='dropdown-item' href='change password' type='button'>
              Change Password
            </a>
          </div>
        </div>
      ...
      <?php while ($row = $result->fetch_assoc()) :
        ...
        <div class='card card-margin'>
          <div class='card-body'>
            ...
            <br>
            <a href='read?q= <?php echo $row['blog_id'] ?>' class='btm-margin btn btn-success'>
              Read more
            </a>
            <a href='edit?q=<?php echo $row['blog_id'] ?>' class='btm-margin btn btn-primary'>
              Edit
            </a>
            <a href='Delete?q=<?php echo $row['blog_id'] ?>' class='btm-margin btn btn-danger' 
