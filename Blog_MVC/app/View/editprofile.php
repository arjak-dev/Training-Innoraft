...
<html>
  ...
  <body>
      ...
      <div class="container text-center">
        ...
        <div class="center">
          <table>
            ...
            enctype="multipart/form-data" id = "form_call"> 
              <tr>
                <td>
                  First Name:
                </td>
              ...
              <tr>
                ...
                <td>
                  <input type="text" id="email_input" name = "email_id" 
                  class="form-control"  
              ...
              <tr>
                ...
                <td>
                  <input type="text" id="phno" name = "phone_no" 
                  class="form-control"  
    ...
    <script src="Script/edit_script.js" 
